...
$result=$db_obj->select('post as p',array('p.id ','p.title','p.text','p.active','p.cat_id','c.name as category'))->join('cat as c','inner','on p.cat_id = c.id')->orderby(array("p.id"=>"desc"))->query_build();
// if($result){
...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">Blog</span>-Health</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="btn btn-primary ml-lg-3" href="log_in.php">Login </a>
            </li>
          </ul>
        </div> <!-- .navbar-collapse -->
      </div> <!-- .container -->
  ...
  <div class="page-section">
    <div class="container">
      <div class="row">
        <?php 
        $site_url =" http://localhost:60/posts/html/blog.php";
        ...
        ?>
                ...
                <div class='row'>
                        ...
                        <div class='card-blog' >
                            ...
                            <div class='body'>                        
                            <h5 class='post-title'><a  id='".str_replace(" ","_",$row->title)."' href='blog-details.html'>".$row->title."</a></h5>
                            <div>".$row->text."</div>
                            <div class='site-info'>
